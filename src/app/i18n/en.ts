export const localeEn = {
  ...
  UserActivityHistory: {
    ...
    Error: 'We could not load the activity history. Please try again later.',
    ProblemAttemptSummary: 'Attempted {{ total }} problems with {{ accepted }} accepted solutions.',
    ChallengeSummary: 'Challenge summary: {{ wins }} wins, {{ draws }} draws, {{ losses }} losses.',
    ProjectAttemptSummary: 'Project attempts: {{ checked }} of {{ total }} checked.',
    TestPassSummary: 'Test results: {{ total }} tests, {{ solved }} solved, {{ completed }} completed.',
    DailyActivityValue: 'Daily activity value: {{ value }}',
    DailyTaskCompleted: 'Completed daily task: "{{ description }}"',
    HardProblemSolvedDescription: 'Solved hard problem:',
    AchievementUnlockedDescription: 'Achievement unlocked:',
    Rank: 'Rank',
    NoRank: 'No rank',
    Bonus: 'Bonus',
    Rating: 'Rating',
