export const localeEn = {
  ...
  Contests: {
    ...
    UserStats: {
      ...
      AverageAttemptsPerProblem: 'Average attempts per problem',
      SingleAttemptProblems: 'Single attempt solves',
      MostAttemptsProblem: 'Most attempts problem',
      FastestSolve: 'Fastest solve',
      SlowestSolve: 'Slowest solve',
      ContestRanks: 'Contest ranks',
      BestRank: 'Best rank',
      WorstRank: 'Toughest contest',
      RatingChanges: 'Rating changes',
      BestDelta: 'Best delta',
      WorstDelta: 'Worst delta',
      Languages: 'Languages usage',
      Verdicts: 'Verdict breakdown',
      Tags: 'Favourite tags',
      Symbols: 'Solved by symbol',
      UnsolvedProblems: 'Unsolved problems',
      TopAttempts: 'Hardest attempts',
      WorthyOpponents: 'Worthy opponents',
      OutOfContestants: 'Out of {{ count }} contestants',
      AttemptsSubtitle: '{{ attempts }} attempts',
      Contestants: '{{ count }} participants',
      SharedContests: '{{ count }} shared contests',
      OpponentContestResult: '#{{ userRank }} vs #{{ opponentRank }} · {{ userPoints }}p vs {{ opponentPoints }}p',
      NoData: 'No data yet',
      SolvedLabel: 'Solved',
      UnsolvedLabel: 'Unsolved',
      AttemptsCount: '{{ count }} attempts',
      ProblemSymbol: 'Problem {{ symbol }}',
    },
  },
  Hackathons: {
    Standings: 'Standings',
