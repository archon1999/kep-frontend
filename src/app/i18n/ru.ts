export const localeRu = {
  ...
  ContestParticipant: "Участник конкурса:",
  ...
  EarnDescription: "Чтобы заработать эту валюту, вам нужно внести свой вклад в развитие системы. Например, kepcoin:",
  ...
  EarnItem4: "За участие в конкурсах",
  ...
  SpendItem5: "Сдать тест",
  SpendItem6: "Покупка курса",
  SpendItem7: "Функция тестирования при редактировании кода (полностью)",
  SpendItem8: "Двойное изменение рейтинга на конкурсе (изменяется в два раза, даже если отрицательное)",
  SpendItem9: "Сохранить рейтинг на конкурсе (не начисляется, если отрицательный)",
  PageTitle: {
    Home: 'Главная',
