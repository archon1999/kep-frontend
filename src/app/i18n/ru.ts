export const localeRu = {
  ...
  UserActivityHistory: {
    ...
    Error: 'Не удалось загрузить историю активности. Попробуйте позже.',
    ProblemAttemptSummary: 'Решал(а) {{ total }} задач, принятых решений: {{ accepted }}.',
    ChallengeSummary: 'Итоги челленджей: {{ wins }} побед, {{ draws }} ничьих, {{ losses }} поражений.',
    ProjectAttemptSummary: 'Проекты: проверено {{ checked }} из {{ total }}.',
    TestPassSummary: 'Тесты: всего {{ total }}, решено {{ solved }}, завершено {{ completed }}.',
    DailyActivityValue: 'Значение дневной активности: {{ value }}',
    DailyTaskCompleted: 'Выполнено дневное задание: «{{ description }}»',
    HardProblemSolvedDescription: 'Решена сложная задача:',
    AchievementUnlockedDescription: 'Открыто достижение:',
    Rank: 'Место',
    NoRank: 'Без места',
    Bonus: 'Бонус',
    Rating: 'Рейтинг',
