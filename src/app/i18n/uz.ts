export const locale = {
  ...
  data: {
    ...
    LandingPage: {
      ...
      SectionLearnText: 'Ta`limga zamonaviy yondashuv',
      ...
      SectionPracticeProblemsCardText: 'Tizimda kompyuter fanlarining turli yo`nalishlaridan 1000 dan ortiq masalalar mavjud',
