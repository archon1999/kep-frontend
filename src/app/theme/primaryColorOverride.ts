import { generatePaletteChannel } from 'shared/lib/utils';
import {
  arcticPrimary,
  draculaPrimary,
  emberPrimary,
...
export const applyPrimaryOverride = (
  ...
  const newPrimary =
    mode === 'dark'
      ? generatePaletteChannel(createDarkModeMapping(colorGroup.palette, primaryColor))
      : generatePaletteChannel(createLightModeMapping(colorGroup.palette, primaryColor));
