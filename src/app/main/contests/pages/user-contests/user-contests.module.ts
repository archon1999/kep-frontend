...
import { NgSelectModule } from 'app/main/third-part-modules/ng-select/ng-select.module';
...
import { MathjaxModule } from 'app/main/third-part-modules/mathjax/mathjax.module';
import { ContestStandingsComponent } from './contest/contest-standings/contest-standings.component';
import { CodeEditorModule } from 'app/main/elements/code-editor/code-editor.module';
...
import { ProblemBodyModule } from 'app/main/problems/elements/problem-body/problem-body.module';
const routes: Routes = [
  {
    path: '',
