...
import DuelsListPageCallComposerForm from './DuelsListPageCallComposerForm.tsx';
...
const DuelsListPageCallComposerCard = ({
  presets,
  duelTypes,
  selectedPresetId,
  selectedTypeId,
...
export default DuelsListPageCallComposerCard;
