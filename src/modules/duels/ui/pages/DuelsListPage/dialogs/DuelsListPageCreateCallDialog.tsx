...
import DuelsListPageCallComposerForm from '../components/DuelsListPageCallComposerForm.tsx';
...
const DuelsListPageCreateCallDialog = ({
  open,
  presets,
  duelTypes,
  disabled,
...
export default DuelsListPageCreateCallDialog;
