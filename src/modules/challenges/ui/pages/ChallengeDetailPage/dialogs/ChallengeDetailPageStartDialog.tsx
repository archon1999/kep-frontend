...
type ChallengeDetailPageStartDialogProps = {
  open: boolean;
  challenge: Challenge;
...
const ChallengeDetailPageStartDialog = ({
  open,
  challenge,
  timerModeLabel,
  starting,
  onStart,
}: ChallengeDetailPageStartDialogProps) => {
...
export default ChallengeDetailPageStartDialog;
