...
import { useAccountTechnologies, useUpdateTechnologies } from 'modules/account-settings/application';
import type { AccountTechnology } from 'modules/account-settings/domain';
