...
var weights = [5, 2, 7, 5, 5, 3, 4, 2, 6, 1, 4, 3, 3, 2, 3, 1, 4];

var rowSize   = 50;
var colSize   = 50;
var gutter    = 7;     // Spacing between tiles
var numTiles  = colspans.length;    // Number of tiles to initially populate the grid with
...
function resize() {
    const width = 800;
    colCount   = oneColumn ? 1 : Math.floor(width / (colSize + gutter));
