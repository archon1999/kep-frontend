import { Box, Chip, ListItem, ListItemButton, ListItemIcon, ListItemText, Stack } from '@mui/material';
...
const ThemeListItem = ({
  ...
  return (
    <ListItem disablePadding>
      <ListItemButton dense selected={isSelected} onClick={() => onSelect(preset)} sx={themeListRowSx(variant, isNested)}>
        <ListItemIcon>
        ...
        <ListItemText
          primary={
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              ...
              {isNew && <Chip size="xsmall" label="new" color="warning" sx={{ textTransform: 'capitalize' }} />}
            </Box>
          }
        />
