...
interface TopnavStackedIllustrationProps {
  active?: boolean;
  hovered?: boolean;
}

export const TopnavStackedIllustration = ({ active, hovered }: TopnavStackedIllustrationProps) => {
    ...
    <svg width="83" height="62" viewBox="0 0 83 62" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g clipPath={`url(#${clipPathId})`}>
        {isActiveOrHovered ? (
          <>
            <g opacity="0.72">
              <rect width="75" height="2.00792" transform="matrix(-1 0 0 1 79 4)" fill={thinTopBarColor} />
            </g>
            <g opacity="0.78">
              <rect width="75" height="4.01583" transform="translate(4 6.00781)" fill={wideTopBarColor} />
            </g>
          </>
        ) : (
          <>
